...
THE LEFT PANEL CAN BE USED AS MANY TIMES AS NEEDED PER NOTE. JUST CLICK 'ANOTHER ONE' 
TO RESET THE OPTIONS. THE TWO SMALLER PANELS ON THE RIGHT ONLY GET USED ONCE PER NOTE.
...
BE IMPORTED AND INSERTED INTO THE APPROPRIATE PLACES. PASTE INTO CMS WHEN FINISHED.
...
WHAT IS AND ISN'T PT, ETC. CLICK ON THE TABS AT THE TOP TO DISPLAY THE INFORMATION.
...
THE QUESTIONS ARE A QUICK REFERENCE ON WHERE AND HOW TO ACCOMPLISH SOME 
'COMMON UNCOMMON' SITUATIONS. 
...
THROUGH WHICH PART TO PRICE, FROM WHERE, AND AT WHAT PRICING. ALL ANSWERS ARE PER SOP 
GUIDELINES.

 -THE 'TRACKER' TAB IS A TOOL THAT HELPS CONSOLIDATE, ORGANIZE, AND ANALYZE CH SERVICE
RECORDS. THERE IS A DEDICATED LINE FOR INCEPTION AND THE SERVICE CLAIM DATE AS WELL AS 
5 ADDITIONAL RECORDS. EACH CAN BE INDIVIDUALLY SAVED OR DELETED THEIR OWN COLLASPABLE 
NOTE. THE OPTIONS AVAILABLE CAN BE RUN IN ANY COMBINATION. 
    - CHECK FOR ISSUES - WILL SORT RECORDS BY AGE AND DISPLAY IN ORDER. THE TOOL
      WILL SET AN ALERT IF THERE ARE ANY MILEAGE DISCREPS OR HMPD, IF THE VEHICLE IS
    ...
    - THE INCEPTION ESTIMATE USES THE INCEPTION INFO, SERVICE CLAIM INFO, AND THE
      RECORD WHICH HAS THE CHECKBOX ACTIVATED WHEN SAVED TO ESTIMATE THE INCEPTION
      MILEAGE. IT WILL, ALSO, OUTPUT THE TIME BETWEEN RECORDS, AVERAGE MILEAGE, TIME 
      AND MILEAGE FROM INCEPTION TO CLAIM, VARIENCE CALCULATIONS, AND ALERT IF THE 
      MILEAGE IS OFF BY MORE THAN 20%.
    - FORMAT FOR NOTE WILL DISPLAY THE ENTERED INFO IN A 'NOTE' FRIENDLY FORMAT WHICH
      INCLUDES ALL RECORDS SORTED AND LABELLED CLEARLY, ANY ALERTS FOUND, AS WELL AS 
      NOTES PREVIOUSLY ENTERED BY THE ADJ.

THE SET OF BUTTONS LABELLED 'RF INBOUND' AND 'CALLED CH' ARE USED TO BUILD 20+ DYNAMI
NOTES IN 3 CLICKS OR LESS. THEY EMCOMPASS A LARGE SWATH OF COMMON SITUATIONS THAT ADJS 
ENCOUNTER ON A  DAILY BASIS. CLICK THROUGH AND READ THE LABELS CLICKED IN ORDER LIKE A 
SENTENCE. THE NOTE GENERATED WITH HAVE ALL THE PERTINENT INFORMATION COPIED TO THE CLIPBOARD
IN 3 CLICKS OR LESS.
...
AND COMPUTER RESTARTS AND UPDATES. THE VERSIONS DO OVERLAP SO BUTTON MODIFICATIONS MADE IN 
'ORIGINAL' WILL AFFECT 'NEUMORPHIC' AS WELL. THE 'APP' AND THE STAND ALONE 'FILE' VERSION
DO NOT OVERLAP. THE STAND ALONE 'FILE' VERSION OPENED IN ONE BROWSER (CHROME) WILL NOT OVERLAP
