...
function checkOpen() {
	...
	const elements = [
		...
		document.getElementById("transferTemplate"),
	];
...
function uncheck_All() {
	...
	const trans_ansNum = document.getElementsByName("trans_ansNum");
...
function FLUIDLEAK() {
	...
	const displayValue = window.getComputedStyle(fluids).display;
...
window.onload = function PutItBack() {
    ...
    var splashImage2 = document.getElementById('splashImage2');

    
    if (window.innerWidth > 1000) {
        splashImage.style.display = 'none';
        splashImage2.style.display = 'block';
